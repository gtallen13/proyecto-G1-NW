...
class Security extends \Dao\Table
{
    ...
    static public function newUsuario($email, $password, $username, $estado, $tipo, $pswdEstado)
    {
        ...
        switch($pswdEstado)
        {
            case "ACT":
                ...
                break;
            case "INA":
                $newUser["userpswdest"] = Estados::INACTIVO;
                break;
            case "BLQ":
        ...
        switch($estado)
        {
            case "ACT":
                ...
                break;
            case "INA":
                $newUser["userest"] = Estados::INACTIVO;
                break;
            case "BLQ":
                $newUser["userest"] = Estados::BLOQUEADO;
                break;
            case "SUS":
                $newUser["userest"] = Estados::SUSPENDIDO;
                break;
